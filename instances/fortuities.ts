...
"SITUATION: The Sandstone Edificers wish to assess your town as a potential source for procurement of raw materials; however, the nearby terrain is unstable to a problematic degree."`)
    }),
    new Memo({
      name: (FORTUITIES.A_SANDSTONE_THROUGHWAY + '1'),
      title: 'A Sandstone Throughway',
      text: (`PROPOSAL: If accepting, you shall erect a of building of any kind to gather data regarding soil compaction and stress tolerance. You shall collect construction resources as specified below. Subsequently, the Edificers will assemble a throughway and begin periodic stops for raw material, for which you will be compensated accordingly.
