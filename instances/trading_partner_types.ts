...
tradingPartnerTypes[TRADING_PARTNERS.FOXFIRE_ASCETICS] = new TradingPartnerType({
  ...
  givesPool: [[
    ...
    {specificity: RSP.EXACT, type: (ETY.SHOULDER_POUCH + ' (U)'), weight: 20, valuable: true}
  ], [
    {specificity: RSP.EXACT, type: RTY.WOOD_ALDER, weight: 200},
    ...
    {specificity: RSP.EXACT, type: RTY.GOLDEN_OIL, weight: 100},
    {specificity: RSP.EXACT, type: RTY.RUMORS_LONG_ANTIQUITY, weight: 100},
    {specificity: RSP.EXACT, type: (ETY.SHOULDER_POUCH + ' (U)'), weight: 25},
    {specificity: RSP.EXACT, type: (ETY.POT_OF_SEALANT_PITCH + ' (U)'), weight: 25, valuable: true}
  ]],
  receivesPool: [[
    ...
    {specificity: RSP.EXACT, type: RTY.WATER, weight: 100},
    {specificity: RSP.EXACT, type: RTY.LENTIL, weight: 100},
    {specificity: RSP.EXACT, type: RTY.SOUP, weight: 50, valuable: true}
  ], [
    {specificity: RSP.EXACT, type: RTY.WATER, weight: 100},
    {specificity: RSP.EXACT, type: RTY.LENTIL, weight: 100},
    {specificity: RSP.EXACT, type: RTY.SOUP, weight: 50, valuable: true}
...
tradingPartnerTypes[TRADING_PARTNERS.TREFOIL_ISLANDS] = new TradingPartnerType({
  ...
  givesPool: [[
    ...
    {specificity: RSP.EXACT, type: RTY.HIBRI_BEETLE, weight: 75},
    ...
    {specificity: RSP.EXACT, type: RTY.POTATO, weight: 100},
    {specificity: RSP.EXACT, type: RTY.BLUEBERRY, weight: 50},
    {specificity: RSP.EXACT, type: RTY.TEA_LEAVES_VIRIDIAN, weight: 100},
    {specificity: RSP.EXACT, type: RTY.SEEDS_OLIVE, weight: 50},
    {specificity: RSP.EXACT, type: RTY.SEEDS_LENTIL, weight: 25},
    ...
    {specificity: RSP.EXACT, type: RTY.GREENISH_ORE, weight: 200},
    {specificity: RSP.EXACT, type: RTY.HIBRI_BEETLE, weight: 75},
    {specificity: RSP.EXACT, type: RTY.FLEECE, weight: 75},
    {specificity: RSP.EXACT, type: RTY.CORAL_BRANCH, weight: 50},
    {specificity: RSP.EXACT, type: RTY.MINT, weight: 50},
    {specificity: RSP.EXACT, type: RTY.ECHINACEA_BLOOM, weight: 100},
    {specificity: RSP.EXACT, type: RTY.RUMORS_ALL_RIVER_DELTA, weight: 100},
    {specificity: RSP.EXACT, type: (ETY.WOODEN_POLE + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.SIMPLE_ROBE + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.REED_MUCK_RAKE + ' (U)'), weight: 25, valuable: true}
  ]],
  receivesPool: [[
    ...
    {specificity: RSP.TAG, type: RTA.FUEL, weight: 16.7, valuable: true},
    {specificity: RSP.SUBCATEGORY, type: RSC.SAND, weight: 100},
    {specificity: RSP.TAG, type: RTA.EARTH, weight: 50},
    {specificity: RSP.TAG, type: RTA.FOOD, weight: 100, valuable: true},
    ...
    {specificity: RSP.EXACT, type: RTY.GRAIN, weight: 50},
    {specificity: RSP.TAG, type: RTA.CROP, weight: 12.5, valuable: true},
    {specificity: RSP.TAG, type: RTA.INGREDIENT, weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: RTY.CARP, weight: 50, valuable: true},
    {specificity: RSP.TAG, type: RTA.ANIMAL, weight: 12.5, valuable: true},
    {specificity: RSP.SUBCATEGORY, type: RSC.OMELET, weight: 50, valuable: true},
    {specificity: RSP.TAG, type: RTA.FOOD, weight: 100, valuable: true},
    {specificity: RSP.TAG, type: RTA.DRINK, weight: 100}
  ], [
    {specificity: RSP.EXACT, type: RTY.THATCH, weight: 50},
    ...
    {specificity: RSP.TAG, type: RTA.POWDER, weight: 12.5, valuable: true},
    {specificity: RSP.TAG, type: RTA.INGREDIENT, weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: RTY.CARP, weight: 50, valuable: true},
    {specificity: RSP.TAG, type: RTA.ANIMAL, weight: 12.5, valuable: true},
    {specificity: RSP.EXACT, type: RTY.ROUGH_ROPE, weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: RTY.BINDING, weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: RTY.HARDENED_SLAB, weight: 25, valuable: true},
    {specificity: RSP.CATEGORY, type: RCA.IMPLEMENT, weight: 25, valuable: true},
    {specificity: RSP.SUBCATEGORY, type: RSC.OMELET, weight: 50, valuable: true},
    {specificity: RSP.TAG, type: RTA.FOOD, weight: 100, valuable: true},
    {specificity: RSP.TAG, type: RTA.DRINK, weight: 100, valuable: true}
  ]],
  initialTrust: 0,
  maxTrust: 1200,
  getTier(trust) {
...
tradingPartnerTypes[TRADING_PARTNERS.RED_CROW_TRADERS] = new TradingPartnerType({
  ...
  givesPool: [[
    ...
    {specificity: RSP.EXACT, type: RTY.ONION, weight: 100},
    {specificity: RSP.EXACT, type: RTY.TOMATO, weight: 50},
    {specificity: RSP.EXACT, type: RTY.ICE, weight: 100},
    {specificity: RSP.EXACT, type: RTY.SAND_CORAL, weight: 50},
    ...
    {specificity: RSP.EXACT, type: RTY.SUGAR_CANE, weight: 50},
    {specificity: RSP.EXACT, type: RTY.WOLFRAM_PEBBLES, weight: 100},
    {specificity: RSP.EXACT, type: RTY.RUMORS_LARCENOUS_ACTIVITY, weight: 100},
    {specificity: RSP.EXACT, type: (ETY.ROUGH_MATTOCK + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.SIMPLE_ROBE + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.CHAR_BELLOWS_FERVENT + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.CHAR_BELLOWS_TEMPERATE + ' (U)'), weight: 25, valuable: true}
  ...
  receivesPool: [[
    ...
    {specificity: RSP.EXACT, type: RTY.CHARCOAL, weight: 50, valuable: true},
    {specificity: RSP.TAG, type: RTA.SMELTED, weight: 50, valuable: true},
    {specificity: RSP.TAG, type: RTA.FUEL, weight: 25, valuable: true},
...
tradingPartnerTypes[TRADING_PARTNERS.SANDSTONE_EDIFICERS] = new TradingPartnerType({
  ...
  givesPool: [[
    ...
    {specificity: RSP.EXACT, type: RTY.DUSTY_ORE, weight: 200},
    {specificity: RSP.EXACT, type: RTY.RUST_ORE, weight: 200},
    {specificity: RSP.EXACT, type: RTY.HIBRI_BEETLE, weight: 50},
    ...
    {specificity: RSP.EXACT, type: RTY.CASTING_PLASTER, weight: 100},
    {specificity: RSP.EXACT, type: (ETY.JOURNEYMANS_TOOLPACK + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.JOURNEYMANS_HAVERSACK + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.CLAY_SPADE_BROAD + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.STURDY_OVERALLS + ' (U)'), weight: 25, valuable: true}
...
tradingPartnerTypes[TRADING_PARTNERS.SPRING_AUTUMN_KINGDOM] = new TradingPartnerType({
  ...
  givesPool: [[
    ...
    {specificity: RSP.EXACT, type: (ETY.ROUGH_MATTOCK + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.WOODEN_POLE + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.COARSE_MEASURES + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.SIMPLE_ROBE + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.JOURNEYMANS_HAVERSACK + ' (U)'), weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.JOURNEYMANS_TOOLPACK + ' (U)'), weight: 25, valuable: true},
    ...
    {specificity: RSP.EXACT, type: RTY.KUMQUAT, weight: 100},
    {specificity: RSP.EXACT, type: RTY.LOTUS_ROOT, weight: 100},
    {specificity: RSP.EXACT, type: RTY.TEA_LEAVES_JASMINE, weight: 200},
    {specificity: RSP.EXACT, type: RTY.WOOD_WILLOW, weight: 200},
    {specificity: RSP.EXACT, type: RTY.RUST_ORE, weight: 50},
    {specificity: RSP.EXACT, type: RTY.GREENISH_ORE, weight: 100},
    {specificity: RSP.EXACT, type: RTY.HIBRI_BEETLE, weight: 50},
    {specificity: RSP.EXACT, type: RTY.CLAY_KAOLIN, weight: 100},
    {specificity: RSP.EXACT, type: RTY.SILKWORM_COCOON, weight: 100},
    {specificity: RSP.EXACT, type: RTY.ANISE, weight: 50},
    {specificity: RSP.EXACT, type: RTY.MERCURY_DROPS, weight: 100},
    {specificity: RSP.EXACT, type: RTY.RUMORS_LONG_ANTIQUITY, weight: 100},
    {specificity: RSP.EXACT, type: (ETY.ROUGH_MATTOCK + ' (U)'), weight: 12, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.WOODEN_POLE + ' (U)'), weight: 12, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.COARSE_MEASURES + ' (U)'), weight: 12, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.SIMPLE_ROBE + ' (U)'), weight: 12, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.JOURNEYMANS_HAVERSACK + ' (U)'), weight: 12, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.JOURNEYMANS_TOOLPACK + ' (U)'), weight: 12, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.JOURNEYMANS_GEARBAG + ' (U)'), weight: 12, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.OLIVE_GRAFTING_SHEARS + ' (U)'), weight: 25, valuable: true}
  ]],
  receivesPool: [[
    {specificity: RSP.EXACT, type: RTY.JADE_TOKEN, weight: 400, valuable: true},
    {specificity: RSP.TAG, type: RTA.PRECIOUS, weight: 50, valuable: true},
    {specificity: RSP.EXACT, type: RTY.GLASS, weight: 100},
    {specificity: RSP.TAG, type: RTA.SMELTED, weight: 25, valuable: true},
    {specificity: RSP.TAG, type: RTA.CONSTRUCTION, weight: 25},
    {specificity: RSP.EXACT, type: RTY.OLIVE_OIL, weight: 100, valuable: true},
    {specificity: RSP.TAG, type: RTA.PRESSED, weight: 25, valuable: true},
    {specificity: RSP.TAG, type: RTA.SPICE, weight: 25, valuable: true},
    {specificity: RSP.TAG, type: RTA.FOOD, weight: 100, valuable: true},
    {specificity: RSP.TAG, type: RTA.DRINK, weight: 100, valuable: true}
  ], [
    {specificity: RSP.EXACT, type: RTY.JADE_TOKEN, weight: 400, valuable: true},
    ...
    {specificity: RSP.TAG, type: RTA.SMELTED, weight: 12.5, valuable: true},
    {specificity: RSP.TAG, type: RTA.CONSTRUCTION, weight: 12.5},
    {specificity: RSP.EXACT, type: RTY.OLIVE_OIL, weight: 50, valuable: true},
    {specificity: RSP.TAG, type: RTA.PRESSED, weight: 12.5, valuable: true},
    {specificity: RSP.TAG, type: RTA.SPICE, weight: 12.5, valuable: true},
    {specificity: RSP.SUBCATEGORY, type: RSC.CAKE, weight: 50, valuable: true},
    {specificity: RSP.TAG, type: RTA.FOOD, weight: 100, valuable: true},
    {specificity: RSP.TAG, type: RTA.DRINK, weight: 100, valuable: true}
  ], [
    {specificity: RSP.EXACT, type: RTY.JADE_TOKEN, weight: 400, valuable: true},
    ...
    {specificity: RSP.TAG, type: RTA.PRESSED, weight: 12.5, valuable: true},
    {specificity: RSP.TAG, type: RTA.SPICE, weight: 12.5, valuable: true},
    {specificity: RSP.EXACT, type: RTY.CRUDE_NEEDLE, weight: 25, valuable: true},
    {specificity: RSP.EXACT, type: RTY.GEARWORK, weight: 25, valuable: true},
    {specificity: RSP.CATEGORY, type: RCA.IMPLEMENT, weight: 25, valuable: true},
    {specificity: RSP.SUBCATEGORY, type: RSC.CAKE, weight: 50, valuable: true},
    {specificity: RSP.TAG, type: RTA.FOOD, weight: 100, valuable: true},
    {specificity: RSP.TAG, type: RTA.DRINK, weight: 100, valuable: true}
...
tradingPartnerTypes[TRADING_PARTNERS.TOURMALINE_JEWELERS] = new TradingPartnerType({
  ...
  givesPool: [[
    ...
    {specificity: RSP.EXACT, type: RTY.AMETHYST_DUSKY, weight: 300},
    {specificity: RSP.EXACT, type: RTY.TOPAZ_SLATE, weight: 225},
    {specificity: RSP.EXACT, type: RTY.LAPIS_LAZULI, weight: 169, valuable: true},
    {specificity: RSP.EXACT, type: RTY.ONYX_HUSK, weight: 127, valuable: true},
    {specificity: RSP.EXACT, type: (ETY.JOURNEYMANS_GEARBAG + ' (U)'), weight: 10},
    {specificity: RSP.EXACT, type: (ETY.COARSE_MEASURES + ' (U)'), weight: 10},
    ...
    {specificity: RSP.EXACT, type: RTY.RUBY_CURSED, weight: 95, valuable: true},
    {specificity: RSP.EXACT, type: RTY.SAPPHIRE_FLOATING, weight: 71, valuable: true},
    // {specificity: RSP.EXACT, type: RTY.EMERALD_REFRACTING, weight: 53},
    // {specificity: RSP.EXACT, type: RTY.DIAMOND_IRRADIENT, weight: 40},
    {specificity: RSP.EXACT, type: RTY.CINNAMON, weight: 50},
    {specificity: RSP.EXACT, type: RTY.CHITENOUS_PINS, weight: 100},
    {specificity: RSP.EXACT, type: RTY.RUMORS_TRANSLOCATED_HALL, weight: 100},
    {specificity: RSP.EXACT, type: (ETY.JOURNEYMANS_GEARBAG + ' (U)'), weight: 5},
    {specificity: RSP.EXACT, type: (ETY.COARSE_MEASURES + ' (U)'), weight: 5},
    {specificity: RSP.EXACT, type: (ETY.APRON_OF_MANY_POCKETS + ' (U)'), weight: 10}
  ]],
  receivesPool: [[
    ...
    {specificity: RSP.EXACT, type: RTY.JADE_TOKEN, weight: 400},
    {specificity: RSP.EXACT, type: RTY.AMETHYST_DUSKY, weight: 300, valuable: true},
    {specificity: RSP.EXACT, type: RTY.TOPAZ_SLATE, weight: 225, valuable: true},
    {specificity: RSP.TAG, type: RTA.TEA, weight: 200},
    {specificity: RSP.EXACT, type: RTY.LAPIS_LAZULI, weight: 169, valuable: true},
    {specificity: RSP.EXACT, type: RTY.ONYX_HUSK, weight: 127, valuable: true},
    {specificity: RSP.EXACT, type: RTY.RUBY_CURSED, weight: 95, valuable: true}
    ...
    {specificity: RSP.EXACT, type: RTY.RUBY_CURSED, weight: 95, valuable: true},
    {specificity: RSP.EXACT, type: RTY.SAPPHIRE_FLOATING, weight: 71, valuable: true},
    {specificity: RSP.EXACT, type: RTY.EMERALD_REFRACTING, weight: 53, valuable: true},
    {specificity: RSP.EXACT, type: RTY.DIAMOND_IRRADIENT, weight: 40, valuable: true}
  ]],
  initialTrust: 0,
  maxTrust: 3000,
  getTier(trust) {
