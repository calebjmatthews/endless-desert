...
export default function SandSvgComponent(props: { icon: Icon }) {
  return (
    <Svg width={props.icon.width} height={props.icon.height} viewBox="0 0 512.08 512.08">
     <g transform="matrix(1.1388 0 0 1.1388 -29.509 -144.46)">
