export enum BUILDING_TYPES {
  ...
  REED_DELTA_CHANNELED = "Channeled Reed Delta",
  GRAIN_FIELD = "Grain Field",
  GRAIN_FIELD_FURROWED = "Furrowed Grain Field",
  ...
  HOUSES = "Houses",
  PRESS = "Press",
  PRESS_COORDINATED = "Coordinated Press",
  ...
  DRYING_YARD_ORGANIZED = "Organized Drying Yard",
  FURNACE = "Furnace",
  FURNACE_BLAST = "Blast Furnace",
  ATELIER = "Atelier",
  ATELIER_ADEPT = "Adept Atelier",
  KITCHEN = "Kitchen",
